...
Since variables and abstractions are values in the lambda calculus, only the application case can step - $$\beta$$-reduction. To make it easier to work with lambda calculus, we introduce a few extensions:
